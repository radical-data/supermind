...
// Props
export const background = false; // if true: sits behind UI, no pointer events + auto-orbit
export const interactive = true; // enable hover/drag/nav
export const height = 560; // used when not background
// NEW: label rendering mode
export const labelMode: "hover" | "always" | "zoom" = "hover";
